...
#include <gtest/gtest.h>
    ...
    {
        list.insert(1300.25, 100, 1, New);
        list.insert(1300.25, 1012, 1, Change);
    ...
    TEST_F(DepthListTest, modifyInvalidIndex)
    {
        ...
        list.insert(1300.25, 100, 1, Change);
    ...
    {
        list.insert(1300.25, 100, 1, New);
        list.insert(1300.25, 100, 1, Delete);
    ...
    TEST_F(DepthListTest, removeInvalidPrice)
    {
        ...
        list.insert(1300.25, 100, 1, New);
        list.insert(1300.5, 100, 1, Delete);
